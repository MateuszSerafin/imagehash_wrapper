...
def process(frames):
    ...
    for frame in frames:
        ...
        b20its.append(crop_resistant_hash(frame, hash_func=imagehash.dhash))
...
def processfile(pool, file):
    ...
    while video_capture.isOpened():
        ...
        if (counter > 3):
            while (psutil.virtual_memory().available / 1024 / 1024 < 6000):
    ...
    ofile = bz2.BZ2File(os.path.basename(file) + '.bz2', 'wb')
